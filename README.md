...
## Quick Start- 🔄 อัพเดทข้อมูลอัตโนมัติทุก 5 วินาที

- ✅ แสดงสถานะการเชื่อมต่อกับ Backend

### 1. Prerequisites- 📱 Responsive Design (รองรับทุกขนาดหน้าจอ)

- Node.js (v18+ recommended)

- npm (v9+ recommended)## การติดตั้ง

- Git

```bash

### 2. Clone the Repository# ติดตั้ง dependencies

```shnpm install

git clone https://github.com/napatpong/tfm_frontend.git

cd tfm_frontend# หรือใช้ yarn
...
Edit `.env.production` with your production values:VITE_API_URL=http://localhost:2052

```VITE_WS_URL=ws://localhost:2052

API_URL=https://scbackend.refritech.co.th:2053VITE_DOMAIN=tfm.refritech.co.th
